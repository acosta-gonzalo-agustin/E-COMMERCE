...
router.get('/booking/:id/:pickup_date/:dropoff_date/:pickup_city/:dropoff_city/:pickup_time/:dropoff_time',booking_session,loggued_booking,productController.reserva);
